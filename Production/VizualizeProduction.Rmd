---
title: 'How data drives early word learning: Production'
...
```{r}
# Load in the data
data = read.csv('All_Data_Production_Summary.csv')
mcdi = read.csv('production-mcdi.csv')
converge = read.csv('All_Data_Production_Convergence.csv')
...
```{r}
# Load in the data
data = read.csv('First_Half_Production_Summary.csv')
converge = read.csv('First_Half_Production_Convergence.csv')
converge$converged = "No"
converge$converged[converge$Rhat_k < 1.2 & converge$Rhat_l < 1.2 & converge$Rhat_s < 1.2] = 'Yes'
