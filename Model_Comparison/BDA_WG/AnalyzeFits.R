...
colnames(Mean) = c('language', 'item.id', 'delta_Mean', 'k_Mean', 'lambda_Mean')
HDIlow = dcast(data, language + item.id ~ X, value.var='HDIlow')
colnames(HDIlow) = c('language', 'item.id', 'delta_HDIlow', 'k_HDIlow', 'lambda_HDIlow')
HDIhigh = dcast(data, language + item.id ~ X, value.var='HDIhigh')
colnames(HDIhigh) = c('language', 'item.id', 'delta_HDIhigh', 'k_HDIhigh', 'lambda_HDIhigh')
